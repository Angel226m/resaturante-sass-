...
import {
  ...
  Building2, Layers, ClipboardList, UserCircle,
} from 'lucide-react';
...
// \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550
// Sidebar \u2014 navegaci\u00f3n principal role-aware
// \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550
...
const adminNav: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/menu', label: 'Men\u00fa', icon: <UtensilsCrossed className="h-5 w-5" /> },
      { to: '/ordenes', label: '\u00d3rdenes', icon: <ShoppingCart className="h-5 w-5" /> },
...
const meseroNav: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/mesero/ordenes', label: 'Mis \u00d3rdenes', icon: <ShoppingCart className="h-5 w-5" /> },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/mesero/menu', label: 'Ver Men\u00fa', icon: <ClipboardList className="h-5 w-5" /> },
...
const cocineroNav: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/cocinero/ordenes', label: '\u00d3rdenes Activas', icon: <ShoppingCart className="h-5 w-5" /> },
      { to: '/cocinero/menu', label: 'Men\u00fa del D\u00eda', icon: <UtensilsCrossed className="h-5 w-5" /> },
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex flex-col border-r border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900',
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b border-slate-200 px-4 dark:border-slate-700">
          {!sidebarCollapsed && (
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h1 className="text-sm font-bold text-slate-900 dark:text-white">RestauFlow</h1>
        ...
        {!sidebarCollapsed && (
          <div className="border-t border-slate-200 px-4 py-3 dark:border-slate-700">
            <div className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-teal-50 to-emerald-50 px-3 py-2 dark:from-teal-900/20 dark:to-emerald-900/20">
              <Crown className="h-4 w-4 text-teal-600" />
              <div className="text-xs">
                <p className="font-medium text-teal-700 dark:text-teal-400">RestauFlow Pro</p>
                <p className="text-teal-600/60 dark:text-teal-500/60">v1.0.0</p>
              </div>
            </div>
          </div>
        )}
